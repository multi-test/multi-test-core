...
var rootReducer = combineReducers([
    ...
    var id = scaleMeta.id, plus = scaleMeta.plus, minus = scaleMeta.minus;
    var setP = new Set(plus);
    var setM = new Set(minus);
...
var computeScales = (function (computedScales) {
...
var validate = buildAnswersValidator(46, [0, 1, 2, 3], createBlankScales(NaN));
