...
var rootReducer = combineReducers([
    ...
    .map(function (_a) {
    var scaleId = _a.scaleId, answer = _a.answer, indices = _a.indices;
    return function (scales, userAnswer, index) {
...
var normalize = (function () {
    var k0_16 = function (k) { return Math.max(0, Math.min(k, 16)); };
    var getCorrectionMatrix = function (k) {
    ...
    var addCorrections = function (scales, corrections) {
    ...
    return function (scales) { return calcT(addCorrections(scales, getCorrectionMatrix(k0_16(scales.K)))); };
}());
var calculate = function (answers) { return normalize(answers.reduce(rootReducer, createBlankScales(0))); };
var validate = buildAnswersValidator(71, ["+", "-"], createBlankScales(NaN));
