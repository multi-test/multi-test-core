...
var normalize = (function () {
    var findIndexOfGreater = function (arr) { return function (val) {
        return arr.reduce(function (i, v) { return i + (val >= v); }, 0);
    }; };
    var meta = [
    ...
    return function (scales) {
        return meta.reduce(function (normalizedScales, _a) {
            var scaleId = _a.scaleId, normalize = _a.normalize;
...
var validate = buildAnswersValidator(44, [-3, -2, -1, 1, 2, 3], createBlankScales(NaN));
