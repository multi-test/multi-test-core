...
var createBlankScales$1 = function (v) {
    return {
        A1: v,
        A2: v,
        A3: v,
...
var validate$1 = buildAnswersValidator(220, ["+", "-"], createBlankScales$1(NaN));
var scaleReducers = [
...
var createBlankScales$2 = function (v) {
    return {
        A: v,
        B: v,
        C: v,
...
var invalidScales = Object.freeze(createBlankScales$2(NaN));
...
var validate$2 = buildAnswersValidator(TOTAL_QUESTIONS, function cattellAnswerValidator(answer, index) {
    switch (index) {
...
function calculateRaw(answers) {
    var scales = createBlankScales$2(0);
...
function calculateNormalized(answers, raw) {
    ...
    var scales = createBlankScales$2(NaN);
...
var createBlankScales$3 = function (v) {
    return {
        МП: v,
        МУ: v,
        ВП: v,
...
var validate$3 = buildAnswersValidator(46, [0, 1, 2, 3], createBlankScales$3(NaN));
...
var createBlankScales$4 = function (v) {
    return {
        "I": v,
        "I.1": v,
        "I.2": v,
...
var validator = buildAnswersValidator(75, [-2, -1, 0, 1, 2], createBlankScales$4(NaN));
...
var createBlankScales$5 = function (v) { return ({
    "L": v,
    "F": v,
    "K": v,
    "1": v,
...
var rootReducer$2 = (function () {
    ...
    return function (scales, answer, index) {
        meta.forEach(function (_a) {
            var scaleId = _a.scaleId, questions = _a.questions;
            var scores = questions[index + 1];
            scales[scaleId] += scores ? scores[answer - 1] : 0;
        });
        return scales;
    };
}());
var calculate$5 = function (answers) { return answers.reduce(rootReducer$2, createBlankScales$5(0)); };
var validate$4 = buildAnswersValidator(71, [1, 2, 3, 4, 5], createBlankScales$5(NaN));
function mendel(answers) {
    return validate$4(answers) || calculate$5(answers);
}

var rootReducer$3 = combineReducers([
...
var calculate$6 = function (answers) { return normalize(answers.reduce(rootReducer$3, createBlankScales$5(0))); };
var validate$5 = buildAnswersValidator(71, ["+", "-"], createBlankScales$5(NaN));
function mmpi(answers) {
    return validate$5(answers) || calculate$6(answers);
}

var createBlankScales$6 = function (v) {
    return {
        "1a": v,
        "1b": v,
        "2a": v,
...
var rootReducer$4 = combineReducers([
    // Адаптивность
...
var validate$6 = buildAnswersValidator(101, [0, 2, 3, 4, 5, 6], createBlankScales$6(NaN));
...
var createBlankScales$7 = function (v) {
    return {
        "Ио": v,
        "Ид": v,
        "Ин": v,
...
var rootReducer$5 = combineReducers([
...
var calculate$8 = function (answers) { return answers.reduce(rootReducer$5, createBlankScales$7(0)); };
var validate$7 = buildAnswersValidator(44, [-3, -2, -1, 1, 2, 3], createBlankScales$7(NaN));
